...
const mockFrames = [
  {
    ...
    description: "Perfect for office work & digital screens",
    style: "classic rectangular",
    match: 95,
  ...
  },
  {
    ...
    price: 349,
    image: "/placeholder.svg?height=200&width=300",
    description: "Statement frames for creative professionals",
    style: "bold acetate",
    match: 89,
    features: ["Lightweight titanium", "Scratch resistant"],
  },
  {
    id: 3,
    name: "Johor Vintage",
    price: 279,
    image: "/placeholder.svg?height=200&width=300",
    description: "Retro charm meets modern comfort",
    style: "vintage round",
    match: 87,
    features: ["Flexible hinges", "UV protection"],
  },
  {
    id: 4,
    name: "Sabah Explorer",
    ...
    style: "sporty wrap",
    match: 84,
    features: ["Impact resistant", "Non-slip grip"],
  },
  {
    id: 5,
    ...
    price: 319,
    image: "/placeholder.svg?height=200&width=300",
    description: "Traditional elegance with modern tech",
    style: "heritage classic",
    match: 82,
    features: ["Progressive lens ready", "Adjustable nose pads"],
  },
  {
    id: 6,
    name: "Selangor Metro",
    price: 259,
    image: "/placeholder.svg?height=200&width=300",
    description: "Urban style for city professionals",
    style: "minimalist metal",
    match: 80,
    features: ["Lightweight design", "Hypoallergenic"],
  },
]
